...
module.exports = {
    ...
    run : async(client, message, args) => {
       ...
       try{
       channelTarget = message.mentions.channels.first() 
       if(!channelTarget) return message.reply(`${emotes.error} | Please mention/tag a channel to delete.`)

       channelTarget.delete()
       .then(ch => {
           message.channel.send(`${emotes.success} Channel Has Been Deleted!`)
       })
      } catch (err) {

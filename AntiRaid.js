...
client.on('guildMemberRemove', async member => {
	...
	let stuff = [
		`${member.guild.id}_${user.id}_rolecreate`,
		`${member.guild.id}_${user.id}_roledelete`,
		`${member.guild.id}_${user.id}_channelcreate`,
		`${member.guild.id}_${user.id}_channeldelete`,
		`${member.guild.id}_${user.id}_banlimit`,
		`${member.guild.id}_${user.id}_kicklimit`
	];

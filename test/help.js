...
module.exports = {
    ...
    usage: `1) ${config.prefix}help \n2) ${config.prefix}help [module name]\n3) ${config.prefix}help [command (name or alias)]`,
    example: `1) ${config.prefix}help\n2) ${config.prefix}help Fun\n3) ${config.prefix}help hackban`,
    aliases: ['th'],
...
message.channel.send(log);
    ...
    .setColor("#d9d9d9") // Set the color
    .setDescription("```js" + `1) Prefix [${config.prefix}help prefix for more info]\n 2) Help [${config.prefix}help for more info]` + "```")
}
